    ...
    Functions: {
      ...
      get_calendar_appointments: {
        ...
        Returns: {
          ...
          notes: string
          overlap_forced_at: string
          overlap_forced_reason: string
          price_cents: number
          resolution: Database["public"]["Enums"]["appointment_resolution"]
          service_id: string
          service_name: string
      ...
      set_barber_queue_enabled: {
        Args: { p_barber_id: string; p_enabled: boolean }
        Returns: {
          created_at: string
          id: string
          is_bookable: boolean
      ...
      set_membership_revenue_visibility: {
        Args: { p_membership_id: string; p_visible: boolean }
        Returns: {
          can_view_revenue: boolean
          created_at: string
          id: string
