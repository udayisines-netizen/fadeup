-- ============================================================================
-- F3 v2 — retour arrière : is_managed revient à la sémantique v1
-- (memberships seulement), corps 20260907230000 verbatim. À APPLIQUER EN
-- postgres. (Le retour à B1 — 30 colonnes — reste le down de 20260907230000.)
-- ============================================================================
