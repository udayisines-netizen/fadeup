-- Down de 20260907170000_x3_null_guard_fixes.sql — restaure à l'identique
-- l'état antérieur (y compris la policy staff_profiles_insert TAUTOLOGIQUE,
-- fidélité oblige). À APPLIQUER EN supabase_admin.
...
drop function if exists private.enforce_staff_profile_identity();
