-- ============================================================================
-- F3 — retour arrière : search_public_professionals revient au contrat B1
-- (30 colonnes, sans is_managed). Corps repris VERBATIM de la production
-- d'avant F3 (pg_get_functiondef, 2026-09-07), ACL et COMMENT reposés à
-- l'identique. À APPLIQUER EN postgres.
-- ============================================================================
